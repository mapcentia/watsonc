...
const DashboardWrapper = React.forwardRef((props, ref) => {
    ...
    const DashboardShellWrapper = (props) => ReactDOM.createPortal(<Provider store={reduxStore}><ThemeProvider><DashboardShell {...props} /></ThemeProvider></Provider>, document.getElementById(DASHBOARD_CONTAINER_ID));
