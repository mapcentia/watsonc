            ...
            <ModalHeader>
                <Grid container>
                    <Grid container item xs={10}>
                        <Title text={__('Få mere ud af Calypso')} color={DarkTheme.colors.headings} />
                    </Grid>
            ...
            <ModalBody>
                <Grid container spacing={8}>
                    <Grid container item xs={6}>
                        ...
                        <PlanItem>
                            <LabelContainer>
                                <Title level={5} text={__('Ubegrænset adgang til data')} color={DarkTheme.colors.headings} />
                            </LabelContainer>
                                <Title level={7} text={__('Data fra Jupiter, pesticid og online stationer samlet ét sted')} color={DarkTheme.colors.gray[3]} />
                        </PlanItem>
                        <PlanItem>
                            <LabelContainer>
                        ...
                        <PlanItem>
                            <LabelContainer>
                                <Title level={5} text={__('Dashboard med grafvisning af data over tid')} color={DarkTheme.colors.headings} />
                            </LabelContainer>
                                <Title level={7} text={__('Gør det nemt at sammenligne data på tværs af boringer')} color={DarkTheme.colors.gray[3]} />
                        </PlanItem>
                        <PlanItem>
                            <LabelContainer>
                                <Title level={5} text={__('Profilværktøj med geologi og kemi')} color={DarkTheme.colors.headings} />
                            </LabelContainer>
                                <Title level={7} text={__('Grafisk visning af geologisk snit med jordlag og boringer')} color={DarkTheme.colors.gray[3]} />
                        </PlanItem>
                        <PlanItem>
                            <LabelContainer>
                    ...
                    <Grid container item xs={2}>
                        <Plan className='short-title'>
                            <PlanItemTitle className="short-title">
                                <LabelContainer>
                                    <Title level={3} text={__('BASIS')} color={DarkTheme.colors.headings} />
                                </LabelContainer>
                                <LabelContainer>
                                    <Title level={7} text={__('Prøv og bliv fortrolig med Calypso - ganske gratis')} color={DarkTheme.colors.gray[3]} align={Align.Center} />
                                </LabelContainer>
                            </PlanItemTitle>
                            <PlanItem>
                               <IconContainer>
                            ...
                            <PlanItem>
                                <PlanFeature>
                                    <Title level={6} text={__('4 gemte grafer')} color={DarkTheme.colors.gray[3]} />
                                </PlanFeature>
                            </PlanItem>
                            <PlanItem>
                                <PlanFeature>
                                    <Title level={6} text={__('1 gemt profil')} color={DarkTheme.colors.gray[3]} />
                                </PlanFeature>
                            </PlanItem>
                            <PlanItem>
                                <PlanFeature>
                    ...
                    <Grid container item xs={2}>
                        <Plan>
                            <PlanItemTitle>
                                <Title level={5} text={__('Calypso for')} color={DarkTheme.colors.gray[3]} />
                                <LabelContainer>
                                    <Title level={3} text={__('Vandværk')} color={DarkTheme.colors.headings} />
                                </LabelContainer>
                                <LabelContainer>
                                    <Title level={7} text={__('200 kr. pr. måned')} color={DarkTheme.colors.gray[3]} align={Align.Center} />
                                </LabelContainer>
                            </PlanItemTitle>
                            <PlanItem>
                               <IconContainer>
                            ...
                            <PlanItem>
                                <PlanFeature>
                                    <Title level={6} text={__('Ubergraenset')} color={DarkTheme.colors.gray[3]} />
                                </PlanFeature>
                            </PlanItem>
                            <PlanItem>
                                <PlanFeature>
                    ...
                    <Grid container item xs={2}>
                        <Plan>
                            <PlanItemTitle>
                                <Title level={5} text={__('Calypso for')} color={DarkTheme.colors.gray[3]} />
                                <LabelContainer>
                                    <Title level={3} text={__('Kommuner')} color={DarkTheme.colors.headings} />
                                </LabelContainer>
                                <LabelContainer>
                                    <Title level={7} text={__('200 kr. pr. måned')} color={DarkTheme.colors.gray[3]} align={Align.Center} />
                                </LabelContainer>
                ...
                <Grid container>
                    ...
                    <Grid container item xs={2}>
                        <SelectPlanButton onClick={() => console.log("Clicked")}>{__('Vælg Vandværk')} </SelectPlanButton>
                    </Grid>
                    <Grid container item xs={2}>
                        <SelectPlanButton onClick={() => console.log("Clicked")}>{__('Vælg Kommune')} </SelectPlanButton>
                    </Grid>
                </Grid>
            </ModalBody>
...
const PlanItemTitle = styled.div`
    ...
    border-radius: ${({ theme }) => `${theme.layout.gutter/4}px ${theme.layout.gutter/4}px 0px 0px`};
    &.short-title {
        height: 64px;
    }
`;
